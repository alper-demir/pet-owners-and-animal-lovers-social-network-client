        ...
        <>
            {
                isLoading ? (
                    ...
                    <div className='w-full max-lg:w-4/5 mx-auto mt-3 border-b-[1px] dark:border-opacity-20 border-gray-200 pb-3 text-[15px] max-sm:p-2 max-sm:pb-3 max-sm:text-xs max-lg:text-sm'>
                            ...
                            <div className='flex flex-col justify-center -mt-1 gap-y-1 dark:text-white'>
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex gap-x-1 items-center">
                                        ...
                                        <div className='flex gap-x-1 font-semibold max-sm:flex-col'>
                                    ...
                                    <div className='flex gap-1 items-center text-[#999999] dark:text-[#777777] cursor-pointer'>
