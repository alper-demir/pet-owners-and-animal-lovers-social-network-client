          ...
          <Link to={`/post/${post._id}`} className="relative group">
            {
              post.image.endsWith("mp4") ? (
                <video src={`${URL}/public/images/${post.image}`} className="cursor-pointer group-hover:scale-95 duration-300 object-cover rounded-md group-hover:shadow-md group-hover:shadow-indigo-200 dark:group-hover:shadow-[#777777] group-hover:opacity-90 h-52 w-full max-md:h-full" />
              ) : (
