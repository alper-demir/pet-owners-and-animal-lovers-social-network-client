...
const Chat = () => {
    ...
    return (
        <div className="flex flex-col h-[80vh] max-sm:h-[78vh] mt-10">
            <div className='border-b pb-3 flex gap-x-2 items-center dark:text-[#f1f1f1]'>
                                ...
                                message.senderId === currentUserId ? (
                                    <div class="flex justify-end" key={index}>
                                        <div className='flex flex-col'>
                                            <div class="bg-blue-200 p-2 rounded-lg max-w-xs dark:bg-indigo-700">
                                                <p>{message.content}</p>
                                            </div>
                                    ...
                                    <div class="flex" key={index}>
                                        <div className='flex flex-col'>
                                            <div class="bg-gray-300 p-2 rounded-lg max-w-xs dark:bg-sky-700">
                                                <p>{message.content}</p>
                                            </div>
            ...
            <div class="bg-gray-50 rounded-md p-4 flex items-center dark:bg-[#161616] dark:text-[#f1f1f1]">
                <input type="text" placeholder="Type your message..." class="flex-1 border rounded-full px-4 py-2 focus:outline-none dark:bg-transparent" value={messageInput}
